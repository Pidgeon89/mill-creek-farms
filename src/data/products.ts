...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "The same raw wildflower honey, steeped with real lemon. Bright enough for tea and a biscuit. A 12-ounce kitchen jar.",
    category: "honey",
    weight: "12 oz",
  ...
  },
  {
    ...
    description:
      "Raw wildflower honey finished with lavender. Soft, not soapy. A Sunday jar. Twelve ounces from the farm kitchen.",
    category: "honey",
    weight: "12 oz",
  ...
  },
  {
    ...
    description:
      "Raw wildflower honey with sliced jalapeño. Sweet first, then a little fire. For fried chicken, cornbread, and a cheese board. A 12-ounce jar.",
    category: "honey",
    weight: "12 oz",
  ...
  },
  {
    ...
    description:
      "Raw wildflower honey steeped with ginger. The jar you reach for when the weather turns. Twelve ounces.",
    category: "honey",
    weight: "12 oz",
  ...
  },
  {
    ...
    description:
      "Raw wildflower honey finished with garlic. Drizzle on biscuits, roasted vegetables, or a pork chop. A 12-ounce kitchen jar.",
    category: "honey",
    weight: "12 oz",
